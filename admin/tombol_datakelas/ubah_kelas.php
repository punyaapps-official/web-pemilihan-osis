...
<body>
	...
	<div class="data">
		...
		$id_kelas 			=	$_GET['id'];
		$data 			= mysqli_query($db ,"SELECT * FROM tb_kelas WHERE id_kelas ='$id_kelas ' " );
		...
		<form action="proses_ubah.php" method="post">
			...
			<div>
				<input type="hidden" name="id_kelas"  id_kelas="id_kelas" class="id_kelas" value="<?php echo $d['id_kelas']; ?>" >
			</div>

			<div>
				Nama Kelas
				<input type="text" name="nama_kelas"  id="nama_kelas" class="nama_kelas" autofocus="" placeholder="masukan nama kelas" required="" autocomplete="off" value="<?php echo $d['nama_kelas']; ?>">
			</div>
